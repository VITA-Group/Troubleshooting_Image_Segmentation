...
sys.path.append(os.path.join(os.path.expanduser('~'), 'MADA'))
...
url_folder = "imgs"
create_dir(url_folder)

def download_imgs():
    with open(os.path.join(COMMON_FLAGS.json_dir, 'keywords.json'), 'r') as fp:
...
if __name__ == '__main__':
    ...
    download_from_json(os.path.join(url_folder, "links-%s-%s.json" % (mindate,maxdate)), 
        download_folder, start_progress=42889)
